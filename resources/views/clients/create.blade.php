...
<div class="grid grid-cols-12 gap-5">
  <div class="col-span-12 xl:col-span-8 space-y-5">
      ...
      <div class="space-y-4">
        <div>
          ...
          <input type="text" name="name" class="form-input @error('name') border-error-300 @enderror"
            value="{{ old('name') }}" placeholder="PT. Nama Perusahaan" />
          @error('name')<p class="mt-1 text-xs text-error-500">{{ $message }}</p>@enderror
        </div>
        <div class="grid grid-cols-2 gap-4">
          <div>
            <label class="form-label">Jenis Perusahaan</label>
            <input type="text" name="company_type" class="form-input" value="{{ old('company_type') }}" placeholder="PT, CV, Yayasan..." />
          </div>
          <div>
            <label class="form-label">Industri</label>
            <input type="text" name="industry" class="form-input" value="{{ old('industry') }}" placeholder="Konstruksi, Property..." />
          </div>
        </div>
        <div class="grid grid-cols-2 gap-4">
          <div>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input type="url" name="website" class="form-input @error('website') border-error-300 @enderror" value="{{ old('website') }}" placeholder="https://..." />
    ...
    <div class="card p-5">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div><label class="form-label">Nama PIC</label><input type="text" name="pic_name" class="form-input" value="{{ old('pic_name') }}" /></div>
        <div><label class="form-label">Jabatan</label><input type="text" name="pic_position" class="form-input" value="{{ old('pic_position') }}" /></div>
        <div><label class="form-label">Telepon PIC</label><input type="text" name="pic_phone" class="form-input" value="{{ old('pic_phone') }}" /></div>
        <div><label class="form-label">Email PIC</label><input type="email" name="pic_email" class="form-input" value="{{ old('pic_email') }}" /></div>
      </div>
    </div>
  ...
  <div class="col-span-12 xl:col-span-4 space-y-5">
    ...
    <div class="flex gap-3">
      <button type="submit" class="btn btn-primary flex-1">Simpan Klien</button>
