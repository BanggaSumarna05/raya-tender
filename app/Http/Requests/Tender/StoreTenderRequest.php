...
class StoreTenderRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('create_tenders');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'submission_deadline' => ['nullable', 'date', 'after_or_equal:received_date'],
    ...
    public function messages(): array
    {
        return [
            ...
            'submission_deadline.after_or_equal' => 'Deadline tidak boleh lebih awal dari tanggal diterima.',
